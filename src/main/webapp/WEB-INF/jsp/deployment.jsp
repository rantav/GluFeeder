...
<table>
  ...
  <tr>
    <td>$ Message:
      <div class="comment">Will be used by yammer</div>
    </td>
...
<div style="display:none">
  <input type="checkbox" checked="checked" name="submitToGlu" />
</div>
<input type="hidden" name="source" value="UI" />
<input type="submit" value="Submit To Glu" onclick="removeServicesLastComma()" />
</form>
